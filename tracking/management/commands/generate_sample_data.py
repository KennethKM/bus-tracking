...
class Command(BaseCommand):
    help = 'Generate sample data for Lusaka Bus Tracking System'
    
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('🚍 Starting Lusaka Bus Tracking System setup...'))
        ...
        for name, lat, lng, route, order in stops:
            Stop.objects.create(name=name, latitude=lat, longitude=lng, route=route, order=order)
        
        self.stdout.write(f'✅ Created {Stop.objects.count()} stops')
        ...
        buses = [
            ...
            ('LUS012', r1, -15.4175, 28.2950, 32, 60),
            ('LUS004', r2, -15.3800, 28.3300, 40, 55),
            ('LUS005', r2, -15.3650, 28.3450, 36, 38),
            ('LUS013', r2, -15.3725, 28.3375, 38, 35),
            ('LUS006', r3, -15.3950, 28.3350, 45, 42),
            ('LUS007', r3, -15.4100, 28.3600, 33, 50),
            ('LUS014', r3, -15.4025, 28.3475, 40, 22),
        ]
        
        for number, route, lat, lng, speed, occupied in buses:
            Bus.objects.create(
                bus_number=number,
                route=route,
                current_lat=lat,
        ...
        self.stdout.write(f'✅ Created {Bus.objects.count()} buses')
        
        # Create test passenger
        self.stdout.write('Creating test passenger...')
        ...
        self.stdout.write(self.style.SUCCESS('✅ LUSAKA BUS TRACKING SYSTEM READY!'))
        ...
        self.stdout.write('   2. Open: http://127.0.0.1:8000')
        self.stdout.write('   3. Allow location access')
        self.stdout.write('   4. Click "Find Buses Near Me"\n')
